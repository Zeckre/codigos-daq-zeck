...
NOMBRE_ARCHIVO = 'muestras-daq.csv' # Nuevo nombre de archivo
...
# --- VALOR DE OFFSET FÍSICO (AJUSTA ESTE VALOR) ---
# Si centraste tu señal de +/-1V alrededor de 0V sumándole 1.6V (VCC/2)
